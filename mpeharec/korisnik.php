			...
			<tr>
				...
				<td>
					<input type="text" name="kor_ime" id="kor_ime"
						...
						?>
						value= "<?php if(!isset($_POST['kor_ime']))echo $kor_ime; else echo $_POST['kor_ime'];?>" size="120" minlength="6" maxlength="50"
			...
			<tr>
				...
				<td>
					<input type="text" name="ime" id="ime" value="<?php if(!isset($_POST['ime']))echo $ime; else echo $_POST['ime'];?>"
						size="120" minlength="1" maxlength="50" placeholder="Ime " required="required"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="prezime" id="prezime" value="<?php if(!isset($_POST['prezime']))echo $prezime; else echo $_POST['prezime'];?>"
						size="120" minlength="1" maxlength="50" placeholder="Prezime " required="required"/>
				</td>
			</tr>
			<tr>
				<td>
